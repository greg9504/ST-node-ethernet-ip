...
class Controller extends ENIP {
     ...
     * @param instance 
     * @param attribute 
     * @param attData buffer with additional data to append to request
     * @returns attribute buffer
     */
    async getAttributeSingle(classID: number, instance: number, attribute: number, attData: Buffer = undefined): Promise<Buffer> {
